module.exports = ({emailFrom, downloadLink, size, expires, shareType = "file", buttonLabel, meta}) => {
    const isFileShare = shareType === "file";
    const summaryLine = meta || (isFileShare
        ? `${size} in total ・ Expires in ${expires}`
        : `Expires in ${expires}`);
    const ctaLabel = buttonLabel || (isFileShare ? "Download file" : "View text");
                        ...
                        <tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%;">
                                ...
                                <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                                    ...
                                    <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;"><b>${emailFrom}</b> has shared ${isFileShare ? "a file" : "text"} with you.</p>
                                    <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">${summaryLine}</p>
